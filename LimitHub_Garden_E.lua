...
title.Text = "RilzzHub script has been updated.\nPlease Chat Telegram Owner!"
...
copyDiscordBtn.MouseButton1Click:Connect(function()
	setclipboard("https://t.me/callnumero")
	copyDiscordBtn.Text = "Copied!"
	task.wait(3)
	copyDiscordBtn.Text = "Copy Telegram Link"
end)

copyLoaderBtn.MouseButton1Click:Connect(function()
	setclipboard("loadstring(game:HttpGet('https://raw.githubusercontent.com/Rilzzxcrash/RilzzHub/refs/heads/main/RilzzHub.lua'))()")
